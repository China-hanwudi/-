# 当前活动主线（TemporalN3 v9）

本仓库当前唯一活动模型主线是 `模型/` 下的 TemporalN3 v9，服务于：
...
`docs/` 中涉及 MELD、IEMOCAP、EmotionTalk 的内容属于历史实验记录和证据，不是当前训练入口、基准或 SOTA 结果。当前活动代码已移除这些数据集的训练/评估入口。
