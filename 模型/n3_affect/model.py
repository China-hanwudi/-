...
class N3EmotionModel(nn.Module):
    ...
    def _current_logits(self, streams: Mapping[str, Tensor]) -> tuple[Tensor, Tensor]:
        """Build the independent current-only anchor."""
    ...
    def forward(
        ...
        current_logits, current_context = self._current_logits(streams)
