...
> **HISTORICAL / SUPERSEDED（2026-08-13）：**本文保留 2026-08-09 对 HarmBench-ERC 等候选路线的构思、检索和决策轨迹，不是当前训练方案。当前执行已切换为 [N3 Phase A/Phase B 两阶段方案](14_最新执行基线与GitHub旧方案差异_2026-08-13.md)；HarmBench 只作历史诊断/辅助 benchmark。本文关于 IEMOCAP 尚无许可、本地资源预算、HarmBench provisional GO 或旧数据封存顺序等与最新状态冲突的内容均不再作为当前口径，也不得据此覆盖最新 test 授权规则。
