...
> **2026-08-13 superseded note：**本文保留为 N3 设计和冻结协议的历史依据。编码器主线已由“文本/音频/视频分别使用情感专用模型”更新为“冻结 `Qwen3-Omni-30B-A3B-Instruct` 分别抽取 T/A/V，并保持当前/历史六路”。共享 3×3、模态/联合双向效用、两级门控和真实分类成功门仍保留；专用编码器改作 baseline/消融。第一轮先执行 emotion-only，utility/VAD 权重为 0。冲突处以 [2026-08-13 最新执行基线](14_最新执行基线与GitHub旧方案差异_2026-08-13.md) 为准。
